...
if __name__ == "__main__":
  ...
  os.mkdir(COMMAND_LINK_FOLDER)

  # add Commands folder full path to PATH
  path_to_add: str = os.path.join(here, COMMAND_LINK_FOLDER)
  ...
  if os.name == "nt":
    for command in COMMANDS.keys():
      ...
      source_file: str = os.path.join(VENV_SCRIPTS_WIN, command_exe)
      link_name: str = os.path.join(COMMAND_LINK_FOLDER, command_exe)
